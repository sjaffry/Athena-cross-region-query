...
DATABASE = workflow_params['OREGON_DATABASE_NAME']
# The S3 bucket\folder\ location where you would like query results saved.
OUTPUT = workflow_params['OREGON_OUTPUT_LOCATION']


response = athena_client.start_query_execution(
    QueryString='''INSERT INTO "nyctaxi-data-db-oregon"."oregon_yellow_aggregated" 
...
workflow_params['joinQueryExecutionIdOregon'] = queryExecutionId
...
print('Query execution id: ' + workflow_params['joinQueryExecutionIdOregon'])
